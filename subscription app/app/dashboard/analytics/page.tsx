...
import { TrendingUp, Calendar, DollarSign, Users, TrendingDown, BarChart3, AlertCircle, PieChart, ArrowUpRight, ArrowDownRight, Zap, Target } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 animate-in-fade">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="h-12 rounded-xl border-border/50 bg-background/50 backdrop-blur-sm font-bold gap-2">
            <Calendar className="w-4 h-4" /> Q1 2024
          </Button>
          ...
          <Card className="glass-card overflow-hidden group animate-in-up delay-300">
            <div className="p-8 border-b border-border/50 flex justify-between items-center bg-muted/20">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" size="sm" className="rounded-lg font-bold text-[10px] h-8 px-3 hover:bg-primary/10 hover:text-primary">DAY</Button>
                <Button variant="secondary" size="sm" className="rounded-lg font-bold text-[10px] h-8 px-3 shadow-md">MONTH</Button>
                <Button variant="ghost" size="sm" className="rounded-lg font-bold text-[10px] h-8 px-3 hover:bg-primary/10 hover:text-primary">YEAR</Button>
              </div>
            </div>
            <div className="p-8">
