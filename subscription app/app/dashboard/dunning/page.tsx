...
import { mockDunningEvents, mockTenants } from '@/lib/mock-data';
    ...
    const handlePauseSubscription = () => {
        toast.promise(
            new Promise(resolve => setTimeout(resolve, 1500)),
            {
                ...
                success: `Subscription for Invoice ${selectedEscalation?.invoiceId} has been paused.`,
                            ...
                            <div className="p-6 rounded-2xl bg-rose-500/5 border border-rose-500/10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs font-bold text-muted-foreground text-muted-foreground">Next Phase: Professional Outreach</p>
