...
import { mockSubscriptionPlans, mockBusinessPlans } from '@/lib/mock-data';
...
export default function PlansPage() {
  ...
  // NOTE: mockSubscriptionPlans and mockBusinessPlans used to be of type SubscriptionPlan,
  // we'll leave the array empty to appease TS, or if they needed to be fetched, they would be done here.
