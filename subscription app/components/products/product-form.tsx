...
import { Save, ArrowLeft, PackagePlus, HelpCircle } from 'lucide-react';
        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-10">
            ...
            <Card className="glass-card p-6 md:p-8 space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3">
                            ...
                            <Input
                                id="name"
                                placeholder="e.g. Daily Fresh Milk (1L)"
                                value={formData.name}
                ...
                <div className="pt-6 flex justify-end gap-3 border-t border-border/50">
                    ...
                    <Button onClick={handleSave} className="h-12 px-8 font-black shadow-xl hover:bg-primary/90">
