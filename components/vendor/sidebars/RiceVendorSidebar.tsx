...
export function RiceVendorSidebar({ onMobileClose }: { onMobileClose?: () => void }) {
  ...
  return (
    <>
      ...
      <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto scrollbar-none">
        {riceVendorMenuGroups.map((group, groupIndex) => (
          <div key={groupIndex} className="mb-6 last:mb-0">
            ...
            {groupIndex < riceVendorMenuGroups.length - 1 && (
      ...
      <div className="p-6 mt-auto">
        <div className="bg-[#111827]/80 rounded-2xl p-4 border border-slate-800/50 cursor-pointer hover:bg-slate-800 transition-all mb-4">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 opacity-70">GSTIN: 23ABCDE1234F1Z5</p>
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold text-slate-200">Business Group</p>
