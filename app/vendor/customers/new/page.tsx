            ...
            <div className="space-y-6">
                ...
                <Card className="border-slate-200/60 shadow-xl shadow-slate-200/20 rounded-2xl overflow-hidden bg-white">
                    ...
                    <div className="p-10 space-y-6 max-w-3xl">
                        ...
                        {/* Wallet Balance */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center pt-4 border-t border-slate-50">
                            <label className="text-sm font-black text-amber-600 flex items-center gap-2 uppercase tracking-widest">
                                <Plus className="w-4 h-4" /> Initial Wallet Credit
                            </label>
                            <div className="md:col-span-2 relative">
                                ...
                                <Input
                                    ...
                                    className="h-12 border-amber-200 focus:border-amber-500 rounded-xl text-sm pl-8 pr-4 bg-amber-50/20 transition-all shadow-sm font-black text-slate-900"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <Card className="border-slate-200/60 shadow-xl shadow-slate-200/20 rounded-2xl overflow-hidden bg-white">
                    ...
                    {isBillingExpanded && (
                        <div className="p-10 space-y-6 max-w-3xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                                ...
                                <div className="md:col-span-2">
                                    <Select value={formData.city} onValueChange={(val) => setFormData({ ...formData, city: val })}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="bangalore">Coimbatore</SelectItem>
                                            <SelectItem value="mumbai">Namakkal</SelectItem>
                                            <SelectItem value="chennai">Erode</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                                ...
                                <div className="md:col-span-2">
                                    <Select value={formData.state} onValueChange={(val) => setFormData({ ...formData, state: val })}>
                                        <SelectTrigger className="hover:bg-slate-50 transition-colors h-11 rounded-xl shadow-sm border-slate-200">
                            ...
                            {/* Postal Code */}
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                                <label className="text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2 block">Postal Code <span className="text-red-500">*</span></label>
                                <div className="md:col-span-2">
