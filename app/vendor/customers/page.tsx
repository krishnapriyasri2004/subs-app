...
import { openSmsForProfile } from '@/lib/twilio-client';
...
export default function CustomersPage() {
  ...
  const handleNotifyBulk = async () => {
    ...
    toast.success(`Broadcasting Completed!`, {
      description: `Payment links were successfully delivered to ${selectedIds.length} customers via SMS.`,
                  ...
                  <td className="py-5 px-4 text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={(e) => { 
                          e.stopPropagation(); 
                          openSmsForProfile(cust, `Hello ${cust.name}, this is regarding your subscription.`); 
                        }}
                      >
