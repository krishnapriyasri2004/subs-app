...
export default function CouponsPage() {
    ...
    const { mockCoupons: coupons, mockTenants, addDocument, deleteDocument, isLoading } = useData();
                                ...
                                <div className="p-6 space-y-6">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className={cn(
                                            ...
                                            {coupon.status}
                                            {isPlatformAdmin && vendor && (
                                                <p className="text-[8px] text-slate-400 font-bold mt-1 max-w-[80px] truncate uppercase">{vendor.name}</p>
                                            )}
                                        </div>
                                    </div>
