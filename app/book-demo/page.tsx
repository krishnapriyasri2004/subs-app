...
export default function BookDemoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { fullName, workEmail, companyName, companySize, industry, phone, expectedRevenue, preferredDate, preferredTimeSlot } = formData;
    if (!fullName || !workEmail || !companyName || !companySize || !industry || !phone || !expectedRevenue || !preferredDate || !preferredTimeSlot) {
    ...
    // Save to Firebase for superadmin persistence
    const newRequest = {
      ...formData,
      id: `demo-${Date.now()}`,
      status: 'pending',
    ...
    try {
      await setDoc(doc(db, 'demoRequests', newRequest.id), newRequest);
    } catch (error) {
      console.error("Error saving demo request:", error);
    }

    // Keep saving to localStorage just in case
    const existingRequests = JSON.parse(localStorage.getItem('subtrack_demo_requests') || '[]');
    localStorage.setItem('subtrack_demo_requests', JSON.stringify([newRequest, ...existingRequests]));
            ...
            <div className="space-y-10 animate-in-up">
              <div className="space-y-6">
                ...
                <p className="text-xl font-bold text-slate-600 tracking-tight">
                  See How Subtrack Can Automate Your Subscription Billing
                </p>
                  ...
                  <div className="space-y-8 w-full">
                    ...
                    <form onSubmit={handleSubmit} className="grid gap-6">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="full-name" className="text-xs font-black uppercase tracking-widest text-slate-400">Full Name <span className="text-red-500">*</span></Label>
                          <Input
                            required
                            id="full-name"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="work-email" className="text-xs font-black uppercase tracking-widest text-slate-400">Work Email <span className="text-red-500">*</span></Label>
                          <Input
                            required
                            id="work-email"
                            type="email"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="company-name" className="text-xs font-black uppercase tracking-widest text-slate-400">Company Name <span className="text-red-500">*</span></Label>
                          <Input
                            required
                            id="company-name"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="company-size" className="text-xs font-black uppercase tracking-widest text-slate-400">Company Size <span className="text-red-500">*</span></Label>
                          <Select
                            required
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="industry" className="text-xs font-black uppercase tracking-widest text-slate-400">Industry <span className="text-red-500">*</span></Label>
                          <Select
                            required
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="phone" className="text-xs font-black uppercase tracking-widest text-slate-400">Phone Number <span className="text-red-500">*</span></Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="revenue" className="text-xs font-black uppercase tracking-widest text-slate-400">Expected Monthly Revenue <span className="text-red-500">*</span></Label>
                        <Select
                          required
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="demo-date" className="text-xs font-black uppercase tracking-widest text-slate-400 flex items-center gap-2">
                            <Calendar className="w-3 h-3 text-blue-600" /> Preferred Date <span className="text-red-500">*</span>
                          </Label>
                          <Input
                            required
                            id="demo-date"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="demo-time" className="text-xs font-black uppercase tracking-widest text-slate-400 flex items-center gap-2">
                            <Clock className="w-3 h-3 text-blue-600" /> Preferred Time Slot <span className="text-red-500">*</span>
                          </Label>
                          <Select
                            required
